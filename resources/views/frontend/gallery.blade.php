...
<section class="pb-44 pt-8 relative z-10">
        ...
        <!-- ✅ Swiper Wrapper -->
        <div class="max-w-[280px] sm:max-w-xl md:max-w-[700px] lg:max-w-2xl mx-auto">
          <div class="partners-swiper-container relative">
            <!-- ✅ Buttons Swiper -->
            <div class="swiper gallery-swiper-btn" >
        ...
        <div class="container relative pt-32">
          ...
          <div
          data-hide-mobile
            class="img-bg absolute bottom-10 -z-10 end-0 translate-x-2/6 rtl:-translate-x-2/6 rtl:-scale-x-[1] translate-y-full"
          >
            <svg
              role="presentation"
              xmlns="http://www.w3.org/2000/svg"
        ...
        <!-- ✅ محتوى التابات (مخزن ومخفي - cache storage) -->
          ...
          <div id="winterExhibition">
            ...
            <div class="swiper gallery-swiper rounded-[50px] overflow-hidden" >
              <div class="swiper-wrapper [&_img]:aspect-square h-[500px]! lg:h-[700]! xl:h-[900px]!">
                ...
                <div class="swiper-slide">
                  <img
                    src="{{asset('assets/images/home/hero/hero-1600.jpg')}}"
                ...
                <div class="swiper-slide">
                  <img
                    src="{{asset('assets/images/home/Banner/1200x500.webp')}}"
                    class="w-full h-full object-cover"
                    alt=""
                  />
                </div>
