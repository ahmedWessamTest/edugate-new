...
<section class="container pb-[100px] pt-[100px] relative">
        <div class=" px-5 relative z-10 pb-[100px]">
          <div
            class="grid grid-cols-1 gap-x-12 gap-y-15 md:grid-cols-2 w-[80%] mx-auto">
            <article class="blog shadow-md rounded-[30px] overflow-hidden">
              <a href="#">
              <figure class="overflow-hidden w-full h-[150px] relative">
                <img
                  class="h-full w-full object-cover"
                  src="../../assets/images/related-blogs/2.webp"
              ...
              <div class="content bg-[#f3fffb] py-4 px-3">
                ...
                <div class="flex items-center gap-x-2">
                  <img
                    class="w-5 h-5"
                    src="../../assets/images/related-blogs/plus.svg"
                    alt="" />
        ...
        <div class="flex justify-center items-center gap-3 mt-6">
          <!-- Circle 1 (active) -->
          <span
            class="w-3 h-3 rounded-full border border-red-500 bg-white"></span>
        ...
        <div class="img-bg absolute bottom-10 end-0 translate-x-2/6 -z-10 rtl:-translate-x-2/6 rtl:-scale-x-[1]  translate-y-18 hidden lg:block" data-hide-mobile>
